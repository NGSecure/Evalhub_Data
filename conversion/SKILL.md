...
> **This repo (evalhub_data).** The prime bundles live under
> `tasks20260922A/`, and the conversion toolkit is a self-contained copy under
...
From the `tasks20260922A/` directory (where the bundles are):
